...
def notify_device_farm_gateway_shutdown_with_slack():
    ...
    """
    print("tttt")
    webhook_url = "https://hooks.slack.com/services/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"
    msg_string = "[NOTICE] device_farm_gateway"
    msg = {"text": f"{msg_string}"}
    res = requests.post(webhook_url, data=json.dumps(msg), headers={'Content-Type': 'application/json'})
